...
export default function Home() {
  return (
    <div className='bg-slate-50'>
      <section>
        <MaxWidthWrapper
          className='pb-24 pt-10 sm:pb-32 lg:pt-24 xl:pt-32 lg:pb-52
        ...
        '>
          <div className='col-span-2 px-6 lg:px-0 lg:pt-4'>
            ...
            '>
              ...
              <h1
                className='relative w-fit tracking-tight z-10
              text-balance mt-16 font-bold !leading-tight
              text-gray-900 text-5xl md:text-6xl lg:text-7xl
              '>
                Your Image on a <span className='bg-green-600 pl-4 pr-5 text-white'>Custom</span>{' '}
                Phone Case
              </h1>
              <p
          ...
          '>
            <div className='relative md:max-w-xl'>
              <div
                className='absolute w-40 lg:w-52 left-52 h-32 
              lg:h-44 -top-20 select-none hidden sm:block lg:hidden xl:block'>
                <Image
                  fill
                  src='/your-image.png'
                  alt='your-image'
            ...
            <div className='flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20'>
              ...
              <div className='text-lg leading-8'>
                <p>
                  ...
                  <span className='px-1 py-0.5 bg-slate-800 text-white'>
        ...
        <MaxWidthWrapper className='py-24'>
            ...
            <div className='mx-auto max-w-2xl sm:text-center'>
              <h2
                ...
                <span className='relative px-2 sm:text-nowrap'>
                  ...
                  <Icons.underline
                    className='hidden sm:block pointer-events-none 
                                absolute inset-x-0 -bottom-6 text-green-500 h-16 w-full'
                  />
                </span>
                <span>now</span>
              </h2>
          ...
          <div className='mx-auto max-w-6xl px-6 lg:px-8'>
            <div className='relative flex flex-col items-center md:grid grid-cols-2 gap-40'>
              ...
              />
              <div
                className='relative w-full md:justify-self-end h-[523px] md:h-auto
              ...
              '>
                <Image
                  ...
                  className='rounded-md object-cover bg-white shadow-2xl ring-1
                   ring-gray-900/10 h-full md:h-auto'
                />
              </div>
              <Phone
